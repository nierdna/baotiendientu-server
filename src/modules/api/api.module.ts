...
import { HealthController, ForumThreadController, UserController, BlogController, CategoryController, TagController, CommentController, LikeController } from '@/api/controllers';
...
const controllers = [HealthController, ForumThreadController, UserController, BlogController, CategoryController, TagController, CommentController, LikeController];
