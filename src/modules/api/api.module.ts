...
import { HealthController, ForumThreadController, UserController, BlogController, CategoryController, TagController } from '@/api/controllers';
...
const controllers = [HealthController, ForumThreadController, UserController, BlogController, CategoryController, TagController];
